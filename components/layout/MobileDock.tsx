    ...
    <div className="lg:hidden">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white border-t px-4 py-2 z-50">
        <div className="flex items-center justify-around">
          ...
          {mockUser.isLoggedIn && mockUser.role === "employer" ? (
            <NavLink 
                ...
                {!mockUser.isLoggedIn ? (
                  ...
                  <>
                    {mockUser.role === "employer" && (
                      <>
                        <Link href="/competitions/create" className="text-lg hover:text-primary">
                          Create Competition
                        </Link>
                        <Link href="/competitions/manage" className="text-lg hover:text-primary">
                          Manage Competitions
                        </Link>
                      </>
                    )}
                    ...
                    {mockUser.role === "employee" && (
                      <>
                        <Link href="/competitions/join" className="text-lg hover:text-primary">
                          Join Competitions
                        </Link>
                        <Link href="/competitions/my" className="text-lg hover:text-primary">
                          My Competitions
                        </Link>
                      </>
                    )}
                    ...
                    <hr className="my-4" />
                    <button className="text-lg hover:text-primary text-left">
                      Logout
                    </button>
                  </>
                )}
